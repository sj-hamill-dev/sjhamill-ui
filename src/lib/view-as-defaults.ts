...
export const DEFAULT_VIEW_AS_TARGETS: ViewAsTarget[] = [
  ...
  { id: "role-exec", name: "Executive User", email: "executive@sjhamill.com", role: "executive", initials: "EX" },
  { id: "role-viewer", name: "Viewer User", email: "viewer@sjhamill.com", role: "viewer", initials: "VW" },
];
